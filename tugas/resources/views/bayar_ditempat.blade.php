  ...
  <body>
      ...
      <div class="container">
        <div class="card" style="width: 25rem; margin: 60px auto 0">
            ...
            <div class="card-body">
              <h5 class="card-title" style="text-align: center; font-size: 22px">Pembayaran Tunai</h5>
              <p style="text-align: center; color: darkblue; font-size: 18px">Rp.{{$price}}</p>
              <p class="card-text" style="text-align: justify">Terimakasih telah melakukan pemesanan rental mobil. silahkan melakukan pembayaran langsung di tempat kantor kami</p>
