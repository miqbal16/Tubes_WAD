  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav" style="margin:auto; font-weight: bold;">
          <li class="nav-item active">
            <button type="button" onclick="location.href='{{route('myAdmin')}}'" class="btn btn-primary">Customer Page</button>       
      ...
      @if ($order->count() > 0)
        <div class="row">
          <div class="col-sm">
            <h2 class="title" style="text-align:center; font-size: 26px; margin: 30px 0 40px; color: #555555">Rent History</h2>
